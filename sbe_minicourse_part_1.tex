...
\begin{frame}{Who is this guy?}
    \begin{itemize}\itemsep1em
        ...
        \item Some of my papers use ML methods in different contexts;
        \end{itemize}
        \pause
        \vspace{1cm}
        \begin{center}
...
\vspace{0.5cm}
    ...
    \begin{itemize}
        ...
        \item Causality in high dimensions, seriously heterogeneous treatment effects, and solving large-scale GE models;
    \end{itemize}
\pause
\vspace{0.5cm}
...
\begin{frame}{What is \textit{Machine Learning}?}
    \begin{itemize}\itemsep1em
        \item Different fields will have different definitions: CS, Stats, Operations Research, ...
        ...
        \pause
        \item For today and tomorrow, everything will be about \textbf{Supervised Learning};
        \pause
...
\vspace{0.5cm}
\fbox{\parbox{0.95\textwidth}{\centering
        \textcolor{FGVBlue}{Machine Learning methods are a \textit{compromise}: they allow for richer parametrizations while still being computationally feasible in high dimensions.}
        }}
\end{frame}
