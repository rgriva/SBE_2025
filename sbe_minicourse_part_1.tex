...
\begin{itemize}
    ...
    \pause
    \item The "curse of dimensionality" kicks in!
    \begin{itemize}
        \item We need exponentially more data as $p$ grows;;
        \item Kernel methods become useless when $p$ is even moderately large (e.g., $p>5$);
    \end{itemize}
    \pause
